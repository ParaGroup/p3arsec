...
bool TrackingModelFF::GetObservation(float timeval)
{
...
ff::ParallelFor* TrackingModelFF::getParallelFor(){
    return _pf;
}

void TrackingModelFF::setParallelFor(ff::ParallelFor* pf){
    _pf = pf;
}
