...
//
//  file :	 ParticleFilterFF.h
//  author : Scott Ettinger - scott.m.ettinger@intel.com
//
//  description : FastFlow parallelized version of the particle filter
...
#ifndef PARTICLEFILTERFF_H
#define PARTICLEFILTERFF_H
...
template<class T> 
class ParticleFilterFF : public ParticleFilter<T> {
...
template<class T>
void ParticleFilterFF<T>::CalcWeights(std::vector<Vectorf > &particles)
{
...
template<class T> 
void ParticleFilterFF<T>::GenerateNewParticles(int k)
{	int p = 0;
