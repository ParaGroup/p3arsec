...
//				  #defines USE_OPENMP, USE_THREADS, USE_TBB or USE_FF. 
//
//  modified : 
//--------------------------------------------------------------
...
//Add defines USE_OPENMP, USE_THREADS, USE_TBB or USE_FF for threaded versions if not using config file (Windows).
//#define USE_OPENMP
//#define USE_THREADS
//#define USE_TBB
//#define USE_FF
...
//Body tracking threaded with FastFlow
#if defined(USE_FF)
int mainFF(string path, int cameras, int frames, int particles, int layers, int threads, bool OutputBMP)
{
	cout << "Threading with FastFlow" << endl;
	cout << "Number of Threads : " << threads << endl;

	TrackingModelFF model;
	...
	switch(threadModel)
	{
		case 0 : 
			...
			break;
                ...
                case 4 :
                        #if defined(USE_FF)
                                mainFF(path, cameras, frames, particles, layers, threads, OutputBMP);             //FastFlow tracking
                                break;
                        #else
                                cout << "Not compiled with FastFlow support. " << endl;
